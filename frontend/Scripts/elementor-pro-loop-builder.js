...
"use strict";
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([[993], {
    2098(e, t, n) {
        var o = n(2470).__;
        ...
        t.default = function addDocumentHandle({element: e, id: t, title: n=o("Template", "elementor-pro")}, a=l, d=null, m=null) {
            if (l === a) {
                if (!t || !e)
            ...
            const c = function createHandleElement({title: e, onClick: t}, n, i=null) {
            ...
            e.prepend(c),
            l === a && (e.dataset.editableElementorDocument = t)
        };
        ...
        function createElement({tag: e, classNames: t=[], children: n=[]}) {
    ...
    2813(e, t, n) {
        ...
        var i = s(n(2195)),
            l = function _interopRequireWildcard(e, t) {
                ...
                return function(e, t) {
                    ...
                    for (const t in e)
                        "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (s = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? s(l, t, i) : l[t] = e[t]);
                    return l
                }(e, t)
            }(n(2098));
        class Loop extends i.default {
            ...
            reInitMasonry()
            {
                ...
                this.elements.$posts = jQuery(`.elementor-element-${this.getID()} ${e.post}`),
                super.runMasonry()
            }
            unbindEvents()
            {
            ...
            {
                super.onInit(...e),
                elementorFrontend.isEditMode() && (this.doEditorInitAction(), this.attachEditDocumentHandle(), this.handleCTA())
            }
        }
        t.default = Loop
    },
