...
"use strict";
(self.webpackChunkelementor_pro = self.webpackChunkelementor_pro || []).push([[961], {
    2590(e, t) {
        ...
        t.default = elementorModules.frontend.handlers.Base.extend({
            ...
            activateHighlightAnimation() {
                ...
                this.prefersReducedMotion || (this.prefersReducedMotion = window.matchMedia("(prefers-reduced-motion: reduce)"));
                this.prefersReducedMotion.matches ? i.addClass(t.activateHighlight) : (i.removeClass(t.hideHighlight).addClass(t.activateHighlight), this.isLoopMode && (setTimeout(() => {
